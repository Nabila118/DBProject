...
<?php $results = mysqli_query($db, "SELECT I.id,P.id AS ITEMNAME, P.BRAND, I.QUANTITY, P.SALES_PRICE, P.SALES_PRICE*I.QUANTITY AS TOTAL FROM INVOICE_13113 I, PRODUCT P WHERE I.Item_ID = P.id"); ?>
